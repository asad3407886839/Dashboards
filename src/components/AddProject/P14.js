      ...
      <div className='p-4 bg-white border-black'>
        ...
        <div className='flex flex-col items-start m-4 space-y-4 md:flex-row md:items-center md:m-4 md:space-y-0 md:space-x-8'>
          ...
          <div className='flex flex-col w-full space-y-4 md:flex-row md:space-y-0 md:space-x-4'>
            <button className='flex items-center w-full px-4 py-3 text-white bg-blue-600 md:w-auto rounded-xl'>
              <FiFileText className='mr-1' />
              View BOQ Summary
            </button>
            <button className='flex items-center w-full px-6 py-3 text-white bg-blue-600 md:w-auto rounded-xl'>
              <FiClipboard className='mr-1' />
              View Job Card
            </button>
            <button className='flex items-center w-full px-16 py-3 text-black bg-gray-300 border-black md:w-auto rounded-xl'>
              Planning Team
            </button>
          </div>
        </div>
