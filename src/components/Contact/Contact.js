...
const Contact = () => {
  ...
  const renderUploadedFiles = (cardTitle) => {
    ...
    return (
      <div className="relative w-auto py-6 mt-4 flex justify-start items-center">
        <div className='bg-gray-200 p-6 flex flex-row rounded-lg'>
          <div className="">
            <img src={getFileLogo(file.type)} alt={`${file.type} logo`} className="h-8 w-8 mr-4" />
  ...
  const renderCard = (title) => (
    <div className=''>
      ...
      <div className="p-6 border border-gray-300 border-dashed rounded-lg shadow-md flex flex-col items-center">
      <img
          src={UploadSvg}
          alt="Upload"
  ...
  return (
    <div className="container px-3 mx-auto mt-6 bg-white z-10">
      <ToastContainer />
      {/* Top Section */}
      <div className="flex flex-col items-center justify-between p-6 border border-black shadow-md md:flex-row rounded-2xl">
        ...
        {/* Right side - Button */}
        <button className="px-8 py-2 font-semibold text-white transition duration-200 ease-in-out bg-custom-gradient rounded-lg shadow-md hover:bg-blue-600">
          + Add File
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 mt-10 md:grid-cols-3">
        ...
        <div>
          ...
          <div className="p-6  flex justify-start items-center">
            <button className="px-10 py-4 font-semibold text-white transition duration-200 ease-in-out bg-custom-gradient rounded-3xl shadow-md hover:bg-blue-600">
              View/Edit Job card
            </button>
          </div>
        </div>
